...
# Set options
LORENE_INC_DIRS_DEFAULT="${LORENE_DIR}/Export/C++/Include ${LORENE_DIR}/C++/Include"
LORENE_LIB_DIRS_DEFAULT="${LORENE_DIR}/Lib ${LORENE_EXTRA_LIB_DIRS}"
LORENE_LIBS_DEFAULT="lorene_export lorene lorenef77 ${LORENE_EXTRA_LIBS}"

LORENE_INC_DIRS_DEFAULT="$(${CCTK_HOME}/lib/sbin/strip-incdirs.sh ${LORENE_INC_DIRS_DEFAULT})"
LORENE_LIB_DIRS_DEFAULT="$(${CCTK_HOME}/lib/sbin/strip-libdirs.sh ${LORENE_LIB_DIRS_DEFAULT})"

: ${LORENE_INC_DIRS=${LORENE_INC_DIRS_DEFAULT}}
: ${LORENE_LIB_DIRS=${LORENE_LIB_DIRS_DEFAULT}}
: ${LORENE_LIBS=${LORENE_LIBS_DEFAULT}}
